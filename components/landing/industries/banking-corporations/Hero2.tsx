        ...
        <div>
            <div className="w-full bg-white px-[10%] py-8">
                <div className="mx-auto w-[80%] md:w-[40%]">
                    <h3 className="text-center text-2xl text-[#004F8F] font-bold">Effortless and Intelligent Lending Solutions <span className="text-black"> for Modern Banks</span></h3>
                </div>
            ...
            <div className="md:flex container mx-auto justify-between items-center mt-8 py-8 bg-gray-300 rounded-lg">
                <div className="md:w-1/2 pl-8 py-8">
                    ...
                    {textList.map((text, index) => (
                        <div key={'banking'+index} className="flex">
            ...
            <div className="sm:w-[80%] md:w-[70%] mx-auto bg-white px-[10%] py-8">
                <div className="text-center py-2">
                    <p className="text-2xl text-black font-bold">Innovation that <span className="text-[#004F8F]">Drives Policy Forward</span></p>
                </div>
                ...
                <hr className="my-4 mx-auto border-t border-[#004F8F] w-[50px] " />
                <div className="text-center">
