    ...
    return (
        <div>
            <div className="bg-gray-100 py-2 text-center text-sm text-gray-600 ">
                <p>
                    ...
                    SIGNUP OFFER: Get 20% OFF on interest on your first Loan.
        ...
        <div className="flex w-1/2 mx-auto justify-between items-center py-8">
            ...
            <div className="w-1/2 pl-8 py-8">
                ...
                <p className="text-2xl text-gray-600 font-bold py-4">Community Credit Groups are at the <span className="text-[#004F8F]">Heart of What We Do</span></p>
