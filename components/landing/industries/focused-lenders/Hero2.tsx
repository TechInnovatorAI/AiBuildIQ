...
const textList = [
    { text: "Clear, actively supervised AI models with robust empirical validation." },
    { text: "Comprehensive Fair Lending reporting and rigorous testing." },
    { text: "Built to align with FCRA, ECOA, and Regulation B, our technology goes beyond regulatory requirements." },
    { text: "Complete Model Risk Management documentation to ensure thorough oversight" },
    { text: "Advanced LDA searches with proprietary algorithmic fairness technology" }
]
        ...
        <div>
            <div className="w-full bg-white px-[10%] py-8">
                <div className="mx-auto w-[80%] md:w-[40%]">
                    <h3 className="text-center text-2xl text-[#004F8F] font-bold">Achieve intelligent and flexible lending <span className="text-black"> for your bank with ease.</span></h3>
                </div>
            ...
            <div className="md:flex md:container mx-auto justify-between items-center mt-8 py-8 bg-gray-300 rounded-lg">
                <div className="md:w-1/2 pl-8 py-8">
                    <p className="text-4xl text-[#004F8F] font-bold py-4">Revolutionizing AI Compliance  <span className="text-black">in Financial Services</span></p>
                    {textList.map((text, index) => (
                        <div key={'focuse'+index}className="flex">
                ...
                <div className="md:w-1/2 p-8">
                    <Image src={LeftImage.src} className="float-right w-[80%] border-white border-2 mx-auto h-[280px] border-2 border-white rounded-lg " alt="Avatar"  width={300} height={150} />
                </div>
            </div>
            <div className="md:w-[70%] mx-auto bg-white px-[10%] py-8">
                <div className="text-center py-2">
                    <p className="text-2xl text-[#004F8F] font-bold">Policy-Driven <span className="text-black">Innovation</span></p>
                </div>
                ...
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-gray-800">Henry Smith</h2>
                    <p className="text-lg text-gray-600">AiBuildIQ Chief Legal and Compliance Officer</p>
                </div>
            </div>
        </div>
    );
