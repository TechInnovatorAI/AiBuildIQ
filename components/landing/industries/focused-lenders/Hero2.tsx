...
const Hero2 = () => {
    ...
    return (
        <div>
            ...
            <div className="w-full bg-white px-[10%] py-8">
                <div className="mx-auto w-[40%]">
                    <h3 className="text-center text-2xl text-[#004F8F]">Achieve intelligent and flexible lending <span className="text-black"> for your bank with ease.</span></h3>
                </div>
                <div className="items-top h-[70vh]">
        ...
        <div className="flex w-1/2 mx-auto justify-between items-center py-8">
            <div className="w-1/2 pl-8 py-8">
                <p className="text-2xl text-[#004F8F] font-bold py-4">Revolutionizing AI Compliance  <span className="text-black">in Financial Services</span></p>
                {textList.map((text, index) => (
                    <p key={index} className="text-gray-500">{index +1 }.{text.text}</p>
                ))}
            </div>
            <div className="w-1/2">
            <Image src={LeftImage.src} className="mx-auto h-[280px] border-2 border-white" alt="Avatar" layout="fixed" width={300} height={150} />
            </div>
        </div>
        <div className="w-[70%] mx-auto bg-white px-[10%] py-8">
            <div className="text-center py-2">
                <p className="text-2xl text-[#004F8F]">Policy-Driven <span className="text-black">Innovation</span></p>
            </div>
