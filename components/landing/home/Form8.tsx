            ...
            <div className="left w-1/2 h-full">
                <div className="relative items-center py-16 justify-center h-full">
                    ...
                    <div className="text-left max-w-4xl mx-auto px-4 py-14">
                        <h1 className="text-white px-[15%] text-8xl md:text-4xl mb-6 font-clash-display ">
                            For More Info Contact Us Today
                        </h1>
                        <h2 className="text-white px-[15%] text-xl md:text-md font-semibold  font-clash-display ">
                ...
                <div className="layer2 mb-4 px-4">
                    <div className="flex justify-between">
                        <div className="w-1/2 mr-2">
                            ...
                            <input type="text" placeholder="First Name" className="w-full p-2 mr-5 rounded-2xl border border-gray-400 bg-[#004F8F]" />
                        </div>
                        <div className="w-1/2">
                            <label className="block text-white">Last Name</label>
                            <input type="text" placeholder="Last Name" className="w-full p-2 border rounded-2xl border-gray-400 bg-[#004F8F]" />
                        </div>
                    </div>
                </div>
                <div className="layer3 mb-4 px-4">
                    <div className="flex justify-between">
                        <div className="">
                            ...
                            <input type="text" placeholder="Email" className="w-full p-2 rounded-2xl border border-gray-400 bg-[#004F8F]" />
                        </div>
                        <div className="">
                            <label className="block text-white">Mobile Number</label>
                            <input type="text" placeholder="Mobile Number" className="w-full p-2 rounded-2xl border border-gray-400 bg-[#004F8F]" />
                        </div>
                    </div>
                </div>
                <div className="layer4 mb-4 px-4">
                    <label className="block text-white">Message or Query</label>
                    <textarea placeholder="Message or Query" className="w-full p-2 rounded-2xl border border-gray-400 bg-[#004F8F]" />
                </div>
                <div className="layer5 px-4">
                    <button className="bg-white text-[#004F8F] p-2 w-1/3 rounded-lg">Send Message</button>
                </div>
            </div>
        </div>
    );
